...
SAMPLE_CASES = [
    {
        ...
        "court": "대법원",
        "date": "2019-05-15",
        "text": "투자계약에서 투자자에게만 일방적 해지권을 부여한 조항은 계약 당사자 간 균형을 현저히 해치는 것으로..."
    },
    {
        ...
        "court": "대법원",
        "date": "2020-08-20",
        "text": "퇴직 후 경업금지 의무를 부과하는 조항은 그 기간, 지역적 범위, 대상 직종 등이 합리적으로 제한되어야..."
    },
    {
        ...
        "court": "서울고등법원",
        "date": "2021-03-10",
        "text": "계약 위반 시 손해배상액을 예정한 조항이 실제 손해에 비해 현저히 과다한 경우 법원은 이를 감액할 수..."
    },
    {
        ...
        "court": "대법원",
        "date": "2018-11-22",
        "text": "위약금 약정이 있는 경우에도 그 액수가 부당하게 과다한 경우 법원은 적당히 감액할 수 있다..."
    },
    {
        ...
        "court": "대법원",
        "date": "2022-03-17",
        "text": "계약서에 면책조항이 있더라도 고의 또는 중대한 과실로 인한 손해배상책임은 면제되지 않는다..."
    }
]
